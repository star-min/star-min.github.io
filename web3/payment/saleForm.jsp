			...
			<table class="table" id="lst_tb">
				<tbody>
					<tr>
						<th>상품명</th>
						<td>
							<input type="text" name="pname" value="${powder.pname }" readonly required>
					...
					<tr>
						<th>수량</th>
						<td>
							<input type="number" name="pamount" min="1" max="${powder.pamount }" value="1">
						</td>
					</tr>
					<tr>
						<th>단가</th>
						<td>
							<input type="text" name="pprice" value="${powder.pprice }" readonly required>
						</td>
					</tr>
					<tr>
						<th>수신자명</th>
